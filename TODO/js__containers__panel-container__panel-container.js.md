...
**Origin:** `js/containers/panel-container/panel-container.js` in `dbl-components`.
**Destination:** `js/containers/panel-container/panel-container.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/containers/panel-container/panel-container.tsx`.
