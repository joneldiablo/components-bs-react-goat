...
**Origin:** `js/forms/fields.js` in `dbl-components`.
**Destination:** `js/forms/fields.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `react-goat` at `fields.ts`.
