...
**Origin:** `js/forms/fields/file-field.js` in `dbl-components`.
**Destination:** `js/forms/fields/file-field.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/fields/file-field.tsx`.
