...
**Origin:** `js/navigation/cards-navigation.js` in `dbl-components`.
**Destination:** `js/navigation/cards-navigation.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/navigation/cards-navigation.tsx`.
