...
**Origin:** `js/containers/card-container.js` in `dbl-components`.
**Destination:** `js/containers/card-container.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/containers/card-container.tsx`.
