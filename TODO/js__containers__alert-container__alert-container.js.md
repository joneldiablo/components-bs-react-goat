...
**Origin:** `js/containers/alert-container/alert-container.js` in `dbl-components`.
**Destination:** `js/containers/alert-container/alert-container.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/containers/alert-container/alert-container.tsx`.
