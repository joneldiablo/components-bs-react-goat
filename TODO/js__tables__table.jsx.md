...
**Origin:** `js/tables/table.jsx` in `dbl-components`.
**Destination:** `js/tables/table.jsx` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/tables/table.tsx`.
