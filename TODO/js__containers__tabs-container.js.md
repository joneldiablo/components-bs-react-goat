...
**Origin:** `js/containers/tabs-container.js` in `dbl-components`.
**Destination:** `js/containers/tabs-container.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/containers/tabs-container.tsx`.
