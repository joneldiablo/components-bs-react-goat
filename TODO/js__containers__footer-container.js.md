...
**Origin:** `js/containers/footer-container.js` in `dbl-components`.
**Destination:** `js/containers/footer-container.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/containers/footer-container.tsx`.
