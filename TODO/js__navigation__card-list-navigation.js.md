...
**Origin:** `js/navigation/card-list-navigation.js` in `dbl-components`.
**Destination:** `js/navigation/card-list-navigation.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/navigation/card-list-navigation.tsx`.
