...
**Origin:** `js/navigation/navigation.js` in `dbl-components`.
**Destination:** `js/navigation/navigation.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `react-goat` at `navigation.ts`.
