...
**Origin:** `js/navigation/side-navigation.js` in `dbl-components`.
**Destination:** `js/navigation/side-navigation.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/navigation/side-navigation.tsx`.
