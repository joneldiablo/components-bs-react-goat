...
**Origin:** `js/forms/fields/autocomplete-field.js` in `dbl-components`.
**Destination:** `js/forms/fields/autocomplete-field.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/fields/autocomplete-field.tsx`.
