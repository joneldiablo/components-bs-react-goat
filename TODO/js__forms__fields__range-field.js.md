...
**Origin:** `js/forms/fields/range-field.js` in `dbl-components`.
**Destination:** `js/forms/fields/range-field.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/fields/range-field.tsx`.
