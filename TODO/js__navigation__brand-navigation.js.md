...
**Origin:** `js/navigation/brand-navigation.js` in `dbl-components`.
**Destination:** `js/navigation/brand-navigation.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/navigation/brand-navigation.tsx`.
