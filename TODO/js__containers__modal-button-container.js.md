...
**Origin:** `js/containers/modal-button-container.js` in `dbl-components`.
**Destination:** `js/containers/modal-button-container.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/containers/modal-button-container.tsx`.
