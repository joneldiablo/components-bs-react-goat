...
**Origin:** `js/navigation/header-navigation.js` in `dbl-components`.
**Destination:** `js/navigation/header-navigation.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/navigation/header-navigation.tsx`.
