...
**Origin:** `js/containers/floating-container/floating-container.jsx` in `dbl-components`.
**Destination:** `js/containers/floating-container/floating-container.jsx` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `react-goat` at `containers/floating-container.tsx`.
