...
**Origin:** `js/navigation/navbar.js` in `dbl-components`.
**Destination:** `js/navigation/navbar.js` in `components-bs-react-goat`.
**Existing TS:** Yes, already exists in `components-bs-react-goat` at `js/navigation/navbar.tsx`.
